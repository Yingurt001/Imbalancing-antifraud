...
# 模型构建
# ========================
def KANS_GRU_model(input_shape, output_dim=1):
...
if __name__ == "__main__":
    results = []
    csv_file_path = 'E4_KAN_GRU_model_results.csv'
        ...
        for blank_interval in blank_intervals:
            ...
            for split_ratio in split_ratios:
                ...
                try:
                    ...
                    model_save_path = f"models/KAN_GRU_best_model_{method}_blank{blank_interval}_{ratio_str}.keras"
