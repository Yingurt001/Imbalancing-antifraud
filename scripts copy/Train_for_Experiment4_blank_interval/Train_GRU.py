...
from keras.layers import GRU, Dense, Dropout, BatchNormalization, Input, Masking, Flatten
...
if __name__ == "__main__":
    results = []
    csv_file_path = 'E4_GRU_model_results.csv'
            ...
            for split_ratio in split_ratios:
                ...
                for run in range(1, 3):
                    try:
                        ...
                        model_save_path = f"models/GRU_best_model_{method}_blank{blank_interval}_{ratio_str}_run{run}.keras"
