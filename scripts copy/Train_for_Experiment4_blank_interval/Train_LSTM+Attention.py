...
def attention_LSTM_model(input_shape):
    ...
    dense_out = Dense(25, activation='relu')(flattened_out)
...
if __name__ == "__main__":
    results = []
    csv_file_path = 'E4_Attention_LSTM_model_results.csv'
            ...
            for split_ratio in split_ratios:
                ...
                for run in range(1, 3):
                    try:
                        ...
                        model = attention_LSTM_model(input_shape)

                        ratio_str = "ratio_original" if split_ratio == "original" else f"ratio1to{split_ratio}"
                        model_save_path = f"models/Attention_LSTM_best_model_{method}_blank{blank_interval}_{ratio_str}_run{run}.keras"
