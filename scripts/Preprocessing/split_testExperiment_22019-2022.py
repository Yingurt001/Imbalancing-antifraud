...
def process_interval(interval):
    ...
    # 保存数据到不同的目录
    output_dir = f'data/npy_test_interval_22年_{interval}'
    save_data(test_X, test_Y, output_dir)

if __name__ == "__main__":
    # 设置输入文件路径
    input_file = "data/processed_data/historical_data_time_2022Q1.csv"
    ...
    if not os.path.exists(input_file):
        ...
        # 定义不同的 interval 值
        intervals = [3, 6, 9]  # 例如，使用三个不同的 interval 进行测试
