...
if __name__ == "__main__":
    results = []
    csv_file_path = 'E3_masked_hybrid_lstm_model_results.csv'
        ...
        for split_ratio in split_ratios:
            ...
            for run in range(1, 21):
                try:
                    ...
                    model_save_path = f'实验三models/真KAN/masked_hybrid_lstm_transformer__best_model_master_data_size_{master_data_size}_ratio1to{split_ratio}_run_{run}.h5'
