...
if __name__ == "__main__":
    results = []
    csv_file_path = 'E3_KAN_LSTM_model_results2020.csv'
            ...
            for split_ratio in split_ratios:
                ...
                for run in range(1, 2):
                    try:
                        ...
                        model_save_path = f'实验三models/真KAN/KAN_LSTM_best_model_{method}_master_data_size_{master_data_size}_ratio1to{split_ratio}_run_{run}.keras'
