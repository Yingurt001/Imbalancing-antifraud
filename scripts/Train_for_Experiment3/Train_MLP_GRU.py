...
if __name__ == "__main__":
    results = []
    csv_file_path = '真KANE3_KAN_GRU_model_results.csv'  # 保存结果的CSV文件路径
    ...
    for master_data_size in master_data_sizes:
        ...
        for run in range(1,  21):  # 每个 master_data_size 运行 20 次
            ...
            try:
                ...
                model_save_path = f'实验三models/真KAN/KAN_GRU_best_model_master_data_size_{master_data_size}_run_{run}.h5'
