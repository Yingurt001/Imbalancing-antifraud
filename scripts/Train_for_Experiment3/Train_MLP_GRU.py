...
if __name__ == "__main__":
        ...
        for master_data_size in master_data_sizes:
            for ratio in split_ratios:
                ...
                for run in range(1, 3):
                    model_path = f"实验三models/真KAN/{method}/MLP_GRU_best_model_master_data_size_{master_data_size}_ratio1to{ratio}_run_{run}.h5"
    ...
    output_csv = "E3_MLP_GRU_all_results.csv"
