...
from keras.layers import GRU, Dense, Masking, Flatten, Input
...
if __name__ == "__main__":
    ...
    if results:
        ...
        results_df.to_csv(f'/Users/zhangying/Documents/Imbalanced_Atten_LSTM/Results/GRU111_results.csv', index=False)
